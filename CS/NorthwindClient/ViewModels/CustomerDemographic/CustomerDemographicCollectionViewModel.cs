...
namespace NorthwindClient.ViewModels {
    ...
    /// </summary>
    public partial class CustomerDemographicCollectionViewModel : CollectionViewModel<CustomerDemographic, string, INorthwind2012EntitiesUnitOfWork> {

        /// <summary>
        /// Creates a new instance of CustomerDemographicCollectionViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static CustomerDemographicCollectionViewModel Create(IUnitOfWorkFactory<INorthwind2012EntitiesUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected CustomerDemographicCollectionViewModel(IUnitOfWorkFactory<INorthwind2012EntitiesUnitOfWork> unitOfWorkFactory = null)
