    ...
    public abstract class SingleObjectViewModelBase<TEntity, TPrimaryKey, TUnitOfWork> : ISingleObjectViewModel<TEntity, TPrimaryKey>, ISupportParameter, IDocumentContent
        ...
        public virtual void Delete() {
            ...
            try {
                ...
                UnitOfWork.SaveChanges();
                TPrimaryKey toMessage = PrimaryKey;
                Entity = null;
                Messenger.Default.Send(new EntityMessage<TEntity, TPrimaryKey>(toMessage, EntityMessageType.Deleted));
                Close();
            }
            catch (DbException e) {
                MessageBoxService.ShowMessage(e.ErrorMessage, e.ErrorCaption, MessageButton.OK, MessageIcon.Error);
        ...
        protected virtual void OnParameterChanged(object parameter) {
            Action<TEntity> entityInitializer = parameter as Action<TEntity>;
