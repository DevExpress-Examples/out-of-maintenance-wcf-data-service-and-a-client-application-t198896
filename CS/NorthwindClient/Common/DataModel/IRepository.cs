...
namespace NorthwindClient.Common.DataModel {
    /// <summary>
    ...
    public static class RepositoryExtensions {
        ...
        public static bool IdDetached<TEntity, TProjection, TPrimaryKey>(this IRepository<TEntity, TPrimaryKey> repository, TProjection projection) where TEntity : class {
            return GetProjectionValue(projection,
